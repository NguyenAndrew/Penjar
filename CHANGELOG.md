...
## [0.39.0] - 2021-7-11
### Added
- Shows TypeScript error lines instead of compiled JavaScript, with source map support, to support easier debugging

## [0.38.0] - 2021-7-10
### Fixed
- Fixed dates on changelog
- Database instructions for backend on README

### Added
- Format and lint backend
- Configuration instructions for backend on README
